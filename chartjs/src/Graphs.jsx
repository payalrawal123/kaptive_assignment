...
const prepareBarData = (month) => {
    return {
        ...
        datasets: [{
            ...
            backgroundColor: 'rgba(75, 182, 197, 0.6)',
        }]
    };
};
...
const Table = () => {
    ...
    return (
        <table {...getTableProps()} style={{ border: 'solid 1px black', margin: '10px 0' }}>
            <thead>
                {headerGroups.map(headerGroup => (
                    <tr {...headerGroup.getHeaderGroupProps()}>
                        {headerGroup.headers.map(column => (
                            <th {...column.getHeaderProps()} style={{ borderBottom: 'solid 3px blue', background: 'aliceblue', color: 'black', fontWeight: 'bold', padding: '10px' }}>
